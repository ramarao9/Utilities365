...
export const ACTION_PARAMS_UPDATE_ID: CLIVerb = { name: ACTION_PARAM_UPDATE_ID_NAME, type:IntelliSenseType.ActionParams, text:ACTION_PARAM_UPDATE_ID_NAME, order:10};
