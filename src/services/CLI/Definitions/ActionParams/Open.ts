...
export const ACTION_PARAM_OPEN_FORM = "form";
...
export const ACTION_PARAM_OPEN_RECORD_FORM_NAME: CLIVerb = {
      name: ACTION_PARAM_OPEN_FORM,
      type: IntelliSenseType.ActionParams, group: GROUP_NAME_OPEN_DEFAULT, groupNumber: 1
};

export const CLI_ACTION_PARAMS_OPEN_RECORD: Array<CLIVerb> =
      [ACTION_PARAM_OPEN_RECORD_APP_NAME,
            ACTION_PARAM_OPEN_RECORD_MODE_NAME,
            ACTION_PARAM_OPEN_RECORD_FORM_NAME];
...
export const CLI_ACTION_PARAMS_OPEN_NEW_RECORD: Array<CLIVerb> =
      [ACTION_PARAM_OPEN_NEW_RECORD_ENTITY_NAME,
            ACTION_PARAM_OPEN_NEW_RECORD_APP_NAME,
            ACTION_PARAM_OPEN_NEW_RECORD_FORM_NAME];
