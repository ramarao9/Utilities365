...
export const ACTION_PARAM_ENTITIES_ENTITIES_NAME = "entity";
export const ACTION_PARAM_ENTITIES_PROPERTIES_NAME = "properties";
export const ACTION_PARAM_ENTITIES_FILTER_NAME = "filter";
...
export const ACTION_PARAMS_ENTITIES_PROPERTIES: CLIVerb = { name: ACTION_PARAM_ENTITIES_PROPERTIES_NAME, description: "CSV of the entity properties", type: IntelliSenseType.ActionParams };
export const ACTION_PARAMS_ENTITIES_FILTER: CLIVerb = { name: ACTION_PARAM_ENTITIES_FILTER_NAME, description: "Specify the OData filter", type: IntelliSenseType.ActionParams };
