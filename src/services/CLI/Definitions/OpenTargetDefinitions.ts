...
export const TARGET_OPEN_ENTITY: CLIVerb = { name: TARGET_OPEN_ENTITY_NAME, description: "", type:IntelliSenseType.Target};
export const TARGET_OPEN_ADVANCED_FIND: CLIVerb = { name: TARGET_OPEN_ADVANCED_FIND_NAME, description: "",type:IntelliSenseType.Target };
