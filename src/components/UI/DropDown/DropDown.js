...
class dropDown extends Component {
  ...
  componentDidUpdate(prevprops) {
    if (
      (prevprops.options == null || prevprops.options.length == 0) &&
  ...
  onDropdownClick = selectedValue => {
    ...
    const currentDropDownOptions = this.getCurrentDropDownOptions(
    ...
    this.setState({
      selections: updatedSelectionsArr,
      ...
      if (currentDropDownOptions.length > 0) {
        options = currentDropDownOptions.map(ddwnOption => (
          <a
            ...
            onClick={() => this.onDropdownClick(ddwnOption.Value)}
      ...
      selectionsDisplay = selectionsArr.map(selection => (
        <a key={selection} className="button is-small is-light">
          ...
          <span
            ...
            onClick={ev => this.removeOption(ev, selection)}
          >
                    ...
                    <div className="dropdown-selection">
                      <div className="selectedItemsDiv w100">
                        ...
                        <input
                          ...
                          type="text"
                          onKeyUp={ev => this.onsearchTextChange(ev)}
                        />
                      </div>
                      <div />
